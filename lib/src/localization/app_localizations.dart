...
abstract class AppLocalizations {
  ...
  /// No description provided for @emptyTitleDesc.
  ///
  /// In en, this message translates to:
  /// **'Title or description is empty.'**
  String get emptyTitleDesc;

  /// No description provided for @notChoosed.
  ///
  /// In en, this message translates to:
  /// **'not choosed'**
  String get notChoosed;

  /// No description provided for @notPickedDeadline.
  ///
  /// In en, this message translates to:
  /// **'Deadline is empty.'**
  String get notPickedDeadline;
  ...
  /// No description provided for @deleteTodoBody.
  ///
  /// In en, this message translates to:
  /// **'Are you sure you want to delete this todo.'**
  String get deleteTodoBody;
